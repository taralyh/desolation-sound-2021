...
(this,function(e){
  ...
  t.version=L.ExtraMarkers.version="1.2.1",
    t.Icon=L.ExtraMarkers.Icon=L.Icon.extend({options:{
      iconSize:[35,45],
      iconAnchor:[17,42],
      popupAnchor:[1,-32],
      shadowAnchor:[10,12],
    ...
    createIcon:function(){
      ...
      &&(e.innerHTML=this._createInner()),
        ...
        t.bgPos
      &&(e.style.backgroundPosition=-t.bgPos.x+"px "+-t.bgPos.y+"px"),
        t.svg?this._setIconStyles(e,"svg"):
      this._setIconStyles(e,t.shape+"-"+t.markerColor),e
    },
    ...
    _createInner:function(){
      ...
      r.number&&(t='number="'+r.number+'" '),
        ...
        r.name.length&&(a+='<div class="'+(void 0!==r.nameClasses?r.nameClasses:"")+'">'+r.name+"</div>"),a
    },
